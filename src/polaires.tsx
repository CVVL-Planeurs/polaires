...
const _polaires =  [
    ...
    // from Shempp Hirth
    [ _T("Arcus"), 700, 185, 110, -0.64, 140, -0.88, 180, -1.47, 15.59, 50.0, 120, 430 ],
    ...
    [ _T("JS-1C (21m)"), 441, 180, 108, -0.52, 156, -1.1, 180, -1.62, 12.25, 56.3, 126, 330 ], // from factory polar
    ...
    [ _T("Ka 6E"),  310, 0, 87.35, -0.81, 141.92, -2.03, 174.68, -3.5, 12.4, 0.0, 85, 185 ], // from idaflieg measured 1970
...
export const polaires : PolaireType[] =  _polaires.map ( (p) => { return {
    ...
    v3: p[7] as number,
    w3: p[8] as number,
    wing_area: p[9] as number,
    v_no: p[10] as number,
    handicap: p[11] as number,
    empty_mass: p[12] as number
}}
)
